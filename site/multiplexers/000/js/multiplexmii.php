...
echo "  $.getScript('apis/nullapi/000/nullapi.js', function() {\n";
echo "    console.log(\"apis/nullapi/000/nullapi.js was loaded\")\n";
echo "  });\n";
echo "  $.getScript('apis/vidapi/000/vidapi.js', function() {\n";
echo "    console.log(\"apis/vidapi/000/vidapi.js was loaded\")\n";
echo "});\n";
...
echo "  return console.log(\"multiplexers/000/css/multiplexmii.css was loaded\");\n";
echo "};\n";
echo "function initalizethecss(){\n";
echo "  return $('body').append('<link rel=\"stylesheet\" href=\"multiplexers/000/css/multiplexmii.css\" type=\"text/css\"></div></body><div class=\"d\" id=\"sessionseed\" hidden>'+Math.random().toString(36).substring(2)+'</div></html>');\n";
echo "}\n";
